...
namespace iRecognizeYou
{
	...
	public class Recognizer
	{
		...
		public void saveToDesktopEigenImages( )
		{
			Tools.saveEigenImages(eor.EigenImages, eor.Labels);
		}
		public void saveToDesktopEigenValues( )
		{
			Tools.saveLabelsWithEigenValues(eor.EigenValues, eor.Labels, "Labels and eigen values.txt");
		}
		/// <summary>
		...
		public override bool Equals( object obj )
		{
			if (base.Equals(obj))
			{
				if (((Recognizer)obj).labels.Length == this.labels.Length)
				{
					return true;
				}
			}
